    ...
    if mcq_options == "Generate":
      ...
      if st.button("Generate", type="primary"):
        with st.spinner("Analyzing and generating questions...This will take a minute."):
            ...
            with open("/data/work/Kyndryl-USDC/demos/mcq-genie/documents/course_details.json", 'r') as f:
              det = json.load(f)
              f.close()
            ...
            with open("/data/work/Kyndryl-USDC/demos/mcq-genie/documents/course_details.json", 'w') as f1:
              json.dump(det, f1)
              f1.close()
